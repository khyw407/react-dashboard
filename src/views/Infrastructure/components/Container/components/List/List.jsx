                ...
                <Table>
                    <TableHead className={classes.tableHead}>
                        <TableRow>
                            ...
                            <TableCell className={classes.tableCell}>Disk Read</TableCell>
                            <TableCell className={classes.tableCell}>Disk Write</TableCell>
                            <TableCell className={classes.tableCell}>Up Time</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {list.map((item, i) => (
