                ...
                <Table>
                    <TableHead className={classes.tableHead}>
                        <TableRow>
                            ...
                            <TableCell className={classes.tableCell}>clusterIP</TableCell>
                            <TableCell className={classes.tableCell}>Internal Endpoint</TableCell>
                                  ...
                                  primary={
                                    <>
                                      <Typography
                                        ...
                                        color="textPrimary"
                                      >
                                        <strong>{item.internalEndpoint}</strong>
                                      </Typography>
                                    </>
                                  }
                              />
